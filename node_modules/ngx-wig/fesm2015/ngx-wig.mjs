...
import { InjectionToken, Injectable, Inject, EventEmitter, forwardRef, ElementRef, Component, ViewEncapsulation, Input, Output, ViewChild, NgModule } from '@angular/core';
...
NgxWigComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: NgxWigComponent, deps: [{ token: NgxWigToolbarService }, { token: DOCUMENT }, { token: 'WINDOW' }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: NgxWigComponent, decorators: [{
        ...
        return [{ type: NgxWigToolbarService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
    ...
    static forRoot(config) {
        return {
            ...
            providers: [
                {
                    provide: BUTTONS,
                    multi: true, useValue: ((!config || !(config === null || config === void 0 ? void 0 : config.buttonsConfig)) ? DEFAULT_LIBRARY_BUTTONS : config === null || config === void 0 ? void 0 : config.buttonsConfig)
                },
...
NgxWigModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: NgxWigModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
NgxWigModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: NgxWigModule, declarations: [NgxWigComponent], imports: [CommonModule,
        FormsModule], exports: [NgxWigComponent] });
NgxWigModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: NgxWigModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.3", ngImport: i0, type: NgxWigModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
                        NgxWigComponent
...
export { BUTTONS, CUSTOM_LIBRARY_BUTTONS, DEFAULT_LIBRARY_BUTTONS, NgxWigComponent, NgxWigModule, NgxWigToolbarService, getWindowObject };
//# sourceMappingURL=ngx-wig.mjs.map
